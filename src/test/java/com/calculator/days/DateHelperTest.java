...
public class DateHelperTest {
    ...
    public void shouldReturnDaysBetweenTwoDates() throws Exception {
        ...
        assertThat(getDaysBetween(new MyDate("22/06/1983"), new MyDate("02/06/1983")), is(19l));
        ...
        assertThat(getDaysBetween(new MyDate("01/03/2015"), new MyDate("27/02/2015")), is(1l));
